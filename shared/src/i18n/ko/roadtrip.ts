...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.ride.departureFlight': '출발 {time}',
  'roadtrip.ride.duration': '예약 기준 소요 시간',
  'roadtrip.ride.checkIn': '체크인',
  'roadtrip.ride.boarding': '탑승',
  'roadtrip.ride.missed': '놓침',
  'roadtrip.ride.lateBy': '{time} 늦음',
  'roadtrip.ride.reachedAt': '{time} 도착',
  'roadtrip.ride.hintFlight': '{title} {departs} 출발, 체크인 마감 {pin}.',
  'roadtrip.ride.hintShip': '{title} {departs} 출항, 체크인 마감 {pin}.',
  'roadtrip.ride.hintBoarding': '{title} {departs} 출발, 탑승 마감 {pin}.',
  'roadtrip.ride.lateHintFlight': '{place}에 {time}에야 도착합니다. {title} {departs} 출발, 체크인 마감 {pin}.',
  'roadtrip.ride.lateHintShip': '{place}에 {time}에야 도착합니다. {title} {departs} 출항, 체크인 마감 {pin}.',
  'roadtrip.ride.lateHintBoarding': '{place}에 {time}에야 도착합니다. {title} {departs} 출발, 탑승 마감 {pin}.',
  'roadtrip.day.rideMissed.flight': '항공편 놓침',
  'roadtrip.day.rideMissed.train': '기차 놓침',
  'roadtrip.day.rideMissed.ferry': '페리 놓침',
  'roadtrip.day.rideMissed.cruise': '크루즈 놓침',
  'roadtrip.day.rideMissed.bus': '버스 놓침',
  'roadtrip.bookend.checkOut': '체크아웃',
  'roadtrip.bookend.from': '하루 시작',
  'roadtrip.bookend.back': '숙박',
  'roadtrip.bookend.checkIn': '체크인',
