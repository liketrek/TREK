...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Markdown 서식',
  'dayplan.markdown.bold': '굵게',
  'dayplan.markdown.italic': '기울임꼴',
  'dayplan.markdown.strikethrough': '취소선',
  'dayplan.markdown.bulletList': '글머리 기호 목록',
  'dayplan.markdown.numberedList': '번호 매기기 목록',
  'dayplan.markdown.inlineCode': '인라인 코드',
  'dayplan.markdown.link': '링크',
