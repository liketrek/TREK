...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': '영수증 스캔',
  'costs.scan.reading': '영수증 읽는 중…',
  'costs.scan.review': '지출 검토',
  'costs.scan.nothingRead': '이 사진에서 영수증을 읽지 못했습니다.',
  'costs.scan.failed': '영수증 읽기를 시작하지 못했습니다.',
  'costs.scan.title': '영수증 스캔',
  'costs.scan.accepted': '영수증 한 장의 사진(JPG, PNG, WEBP, 최대 10MB). AI 모델이 백그라운드에서 읽은 뒤, 저장하기 전에 지출을 확인합니다.',
  'costs.scan.dropHere': '영수증 사진을 여기에 놓거나, 클릭해서 선택하거나 촬영하세요',
  'costs.scan.dropActive': '놓아서 사진 스캔',
  'costs.scan.start': '스캔',
  'costs.scan.unsupported': '사진만 스캔할 수 있습니다: JPG, PNG, WEBP.',
