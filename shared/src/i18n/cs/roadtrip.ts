...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.ride.duration': 'Doba podle rezervace',
  'roadtrip.ride.checkIn': 'Check-in',
  'roadtrip.ride.boarding': 'Nástup',
  'roadtrip.ride.missed': 'Zmeškáno',
  'roadtrip.ride.lateBy': 'zpoždění {time}',
  'roadtrip.ride.reachedAt': 'až v {time}',
  'roadtrip.ride.hintFlight': '{title} odlétá v {departs}, check-in do {pin}.',
  'roadtrip.ride.hintShip': '{title} vyplouvá v {departs}, check-in do {pin}.',
  'roadtrip.ride.hintBoarding': '{title} odjíždí v {departs}, nástup do {pin}.',
  'roadtrip.ride.lateHintFlight': '{place}: příjezd až v {time}. {title} odlétá v {departs}, check-in do {pin}.',
  'roadtrip.ride.lateHintShip': '{place}: příjezd až v {time}. {title} vyplouvá v {departs}, check-in do {pin}.',
  'roadtrip.ride.lateHintBoarding': '{place}: příjezd až v {time}. {title} odjíždí v {departs}, nástup do {pin}.',
  'roadtrip.day.rideMissed.flight': 'Zmeškaný let',
  'roadtrip.day.rideMissed.train': 'Zmeškaný vlak',
  'roadtrip.day.rideMissed.ferry': 'Zmeškaný trajekt',
  'roadtrip.day.rideMissed.cruise': 'Zmeškaná plavba',
  'roadtrip.day.rideMissed.bus': 'Zmeškaný autobus',
  'roadtrip.bookend.checkOut': 'Check-out',
  'roadtrip.bookend.from': 'Začátek dne',
  'roadtrip.bookend.back': 'Nocleh',
