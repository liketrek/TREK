...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Formátování Markdown',
  'dayplan.markdown.bold': 'Tučné',
  'dayplan.markdown.italic': 'Kurzíva',
  'dayplan.markdown.strikethrough': 'Přeškrtnuté',
  'dayplan.markdown.bulletList': 'Odrážkový seznam',
  'dayplan.markdown.numberedList': 'Číslovaný seznam',
  'dayplan.markdown.inlineCode': 'Řádkový kód',
  'dayplan.markdown.link': 'Odkaz',
