...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Naskenovat účtenku',
  'costs.scan.reading': 'Čtení účtenky…',
  'costs.scan.review': 'Zkontrolovat výdaj',
  'costs.scan.nothingRead': 'Z této fotografie se nepodařilo přečíst žádnou účtenku.',
  'costs.scan.failed': 'Čtení účtenky se nepodařilo spustit.',
  'costs.scan.title': 'Naskenovat účtenku',
  'costs.scan.accepted': 'Fotografie jedné účtenky (JPG, PNG nebo WEBP, do 10 MB). Model AI ji přečte na pozadí a vy pak výdaj před uložením zkontrolujete.',
  'costs.scan.dropHere': 'Přetáhněte sem fotografii účtenky, nebo klikněte a vyberte či pořiďte novou',
  'costs.scan.dropActive': 'Pusťte fotografii pro naskenování',
  'costs.scan.start': 'Skenovat',
  'costs.scan.unsupported': 'Skenovat lze jen fotografii: JPG, PNG nebo WEBP.',
