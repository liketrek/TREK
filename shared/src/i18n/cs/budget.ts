...
const budget: TranslationStrings = {
  ...
  'costs.exchangeRates.manage': 'Směnné kurzy',
  'costs.exchangeRates.title': 'Směnné kurzy cesty',
  'costs.exchangeRates.description':
    'Kurzy cesty jsou výchozí pro nové výdaje a platby. Dříve uložené kurzy se nezmění, pokud je níže nevyberete.',
  'costs.exchangeRates.notePlaceholder': 'Volitelná poznámka',
  'costs.exchangeRates.updateExisting': 'Aktualizovat existující položky (vyžaduje náhled)',
  'costs.exchangeRates.noMatchingItems': 'Žádné odpovídající existující položky.',
  'costs.exchangeRates.savedDefaults': 'Uložené výchozí hodnoty',
  'costs.exchangeRates.noTripRates': 'Žádné kurzy specifické pro cestu.',
  'costs.exchangeRates.applyItems': 'Použít na {count} položek',
  'costs.exchangeRates.previewChanges': 'Náhled změn',
  'costs.exchangeRates.saveDefault': 'Uložit jako výchozí',
  'costs.exchangeRates.label': 'Směnný kurz',
  'costs.exchangeRates.required': 'Povinné',
  'costs.exchangeRates.manualRate': 'Ruční kurz',
  'costs.exchangeRates.sourceLabel': 'Zdroj: {source}',
  'costs.exchangeRates.suggestedLabel': 'Suggested: {source}',
  'costs.exchangeRates.staleSnapshot': 'Zastaralá data poskytovatele',
  'costs.exchangeRates.manualRequired': 'Pro uložení zadejte kurz ručně',
  'costs.exchangeRates.source.identity': 'stejná měna',
  'costs.exchangeRates.source.global': 'globální kurz',
  'costs.exchangeRates.source.trip': 'výchozí kurz cesty',
  'costs.exchangeRates.source.explicit': 'ruční kurz',
  'costs.exchangeRates.source.legacy': 'starší kurz',
  'costs.exchangeRates.source.unavailable': 'nedostupné',
  'costs.exchangeRates.item.expense': 'Výdaj',
  'costs.exchangeRates.item.settlement': 'Platba',
  'costs.exchangeRates.toast.saveError': 'Směnný kurz se nepodařilo uložit',
  'costs.exchangeRates.toast.previewOutdated': 'Data se změnila; vytvořte nový náhled',
  'costs.exchangeRates.toast.applyError': 'Směnný kurz se nepodařilo použít',
};
