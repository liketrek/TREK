...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.departureIn': 'Odjezd za',
  'dashboard.hero.hourUnit': 'hodin',
  'dashboard.hero.minuteUnit': 'minut',
  'dashboard.hero.secondUnit': 'sekund',
  ...
  'dashboard.fx.staleSnapshot': 'Zastaralý snímek',
};
