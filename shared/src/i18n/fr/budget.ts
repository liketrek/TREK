...
const budget: TranslationStrings = {
  ...
  'costs.exchangeRates.description':
    'Les taux du voyage servent de valeurs par défaut aux nouveaux frais et paiements. Les taux déjà enregistrés restent inchangés, sauf s’ils sont sélectionnés ci-dessous.',
