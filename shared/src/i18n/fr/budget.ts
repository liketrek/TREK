...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Scanner un reçu',
  'costs.scan.reading': 'Lecture du reçu…',
  'costs.scan.review': 'Vérifier la dépense',
  'costs.scan.nothingRead': "Aucun reçu n'a pu être lu sur cette photo.",
  'costs.scan.failed': 'Impossible de lancer la lecture du reçu.',
  'costs.scan.title': 'Scanner un reçu',
  'costs.scan.accepted': "Une photo d'un seul reçu (JPG, PNG ou WEBP, 10 Mo max). Le modèle d'IA la lit en arrière-plan, puis vous vérifiez la dépense avant de l'enregistrer.",
  'costs.scan.dropHere': 'Déposez la photo du reçu ici, ou cliquez pour en choisir ou en prendre une',
  'costs.scan.dropActive': 'Déposez la photo pour la scanner',
  'costs.scan.start': 'Scanner',
  'costs.scan.unsupported': 'Seule une photo peut être scannée : JPG, PNG ou WEBP.',
