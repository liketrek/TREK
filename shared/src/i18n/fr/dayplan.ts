...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Mise en forme Markdown',
  'dayplan.markdown.bold': 'Gras',
  'dayplan.markdown.italic': 'Italique',
  'dayplan.markdown.strikethrough': 'Barré',
  'dayplan.markdown.bulletList': 'Liste à puces',
  'dayplan.markdown.numberedList': 'Liste numérotée',
  'dayplan.markdown.inlineCode': 'Code en ligne',
  'dayplan.markdown.link': 'Lien',
