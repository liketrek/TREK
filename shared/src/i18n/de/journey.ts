...
const journey: TranslationStrings = {
  ...
  'journey.studio.bookName': 'Buchname',
  'journey.studio.namePlaceholder': 'Wie soll das Buch heißen?',
  ...
  'journey.studio.desktopOnlyHint': 'Ein Buch zu gestalten braucht Fläche, deshalb gibt es Studio nur am Desktop. Deine Journey und der PDF-Export funktionieren hier wie gewohnt.',
  ...
  'journey.studio.frames': 'Bildrahmen',
