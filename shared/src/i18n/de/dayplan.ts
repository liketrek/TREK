...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Markdown-Formatierung',
  'dayplan.markdown.bold': 'Fett',
  'dayplan.markdown.italic': 'Kursiv',
  'dayplan.markdown.strikethrough': 'Durchgestrichen',
  'dayplan.markdown.bulletList': 'Aufzählung',
  'dayplan.markdown.numberedList': 'Nummerierte Liste',
  'dayplan.markdown.inlineCode': 'Inline-Code',
