...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.departureIn': 'Abfahrt in',
  'dashboard.hero.hourUnit': 'Stunden',
  'dashboard.hero.minuteUnit': 'Minuten',
  'dashboard.hero.secondUnit': 'Sekunden',
  ...
  'dashboard.fx.staleSnapshot': 'Veralteter Datenstand',
};
