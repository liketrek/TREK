...
const reservations: TranslationStrings = {
  ...
  'reservations.import.needsReview': '待檢查',
  'reservations.import.tryAi': '嘗試使用 AI 解析',
  'reservations.import.aiParsing': '正在使用 AI 解析…',
  ...
  'reservations.createExpenseHint': '先儲存預訂，再開啟費用編輯器。',
  'reservations.linkedExpense': '已連結的支出',
  'reservations.removeExpense': '移除連結的支出',
