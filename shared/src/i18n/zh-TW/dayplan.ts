...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Markdown 格式',
  'dayplan.markdown.bold': '粗體',
  'dayplan.markdown.italic': '斜體',
  'dayplan.markdown.strikethrough': '刪除線',
  'dayplan.markdown.bulletList': '項目符號清單',
  'dayplan.markdown.numberedList': '編號清單',
  'dayplan.markdown.inlineCode': '行內程式碼',
  'dayplan.markdown.link': '連結',
