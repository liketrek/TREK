...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': '掃描收據',
  'costs.scan.reading': '正在讀取收據…',
  'costs.scan.review': '檢查支出',
  'costs.scan.nothingRead': '無法從這張照片讀取收據。',
  'costs.scan.failed': '無法開始讀取收據。',
  'costs.scan.title': '掃描收據',
  'costs.scan.accepted': '一張收據的照片（JPG、PNG 或 WEBP，最大 10 MB）。AI 模型會在背景讀取，儲存前你可以檢查這筆支出。',
  'costs.scan.dropHere': '將收據照片拖到這裡，或點擊選擇或拍攝照片',
  'costs.scan.dropActive': '放開以掃描照片',
  'costs.scan.start': '掃描',
  'costs.scan.unsupported': '只能掃描照片：JPG、PNG 或 WEBP。',
