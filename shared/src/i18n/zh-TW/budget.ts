...
const budget: TranslationStrings = {
  ...
  'costs.amount': '金額',
  'costs.split': '分攤',
  'costs.splitEqually': '平均分攤',
  'costs.splitCustom': '自訂金額',
  'costs.splitTicket': '按帳單明細',
  'costs.filter.allCategories': '所有類別',
  'costs.filter.allDays': '所有日期',
  'costs.expensesCount': '{count} 筆支出',
  'costs.exchangeRates.manage': '匯率',
  'costs.exchangeRates.title': '旅程匯率',
  'costs.exchangeRates.description': '旅程匯率是新支出與付款的預設值。除非在下方選取，否則已儲存的匯率不會變更。',
  'costs.exchangeRates.notePlaceholder': '選填備註',
  'costs.exchangeRates.updateExisting': '更新現有項目（需要預覽）',
  'costs.exchangeRates.noMatchingItems': '沒有相符的現有項目。',
  'costs.exchangeRates.savedDefaults': '已儲存的預設值',
  'costs.exchangeRates.noTripRates': '沒有旅程專用匯率。',
  'costs.exchangeRates.applyItems': '套用至 {count} 個項目',
  'costs.exchangeRates.previewChanges': '預覽變更',
  'costs.exchangeRates.saveDefault': '儲存預設值',
  'costs.exchangeRates.label': '匯率',
  'costs.exchangeRates.required': '必填',
  'costs.exchangeRates.manualRate': '手動匯率',
  'costs.exchangeRates.sourceLabel': '來源：{source}',
  'costs.exchangeRates.suggestedLabel': '建議：{source}',
  'costs.exchangeRates.staleSnapshot': '服務商快照已過期',
  'costs.exchangeRates.manualRequired': '請輸入手動匯率後儲存',
  'costs.exchangeRates.source.identity': '相同貨幣',
  'costs.exchangeRates.source.global': '全域匯率',
  'costs.exchangeRates.source.trip': '旅程預設值',
  'costs.exchangeRates.source.explicit': '明確提供的匯率',
  'costs.exchangeRates.source.legacy': '舊版匯率',
  'costs.exchangeRates.source.unavailable': '無法使用',
  'costs.exchangeRates.item.expense': '支出',
  'costs.exchangeRates.item.settlement': '付款',
  'costs.exchangeRates.toast.saveError': '無法儲存匯率',
  'costs.exchangeRates.toast.previewOutdated': '資料已變更；請建立新的預覽',
  'costs.exchangeRates.toast.applyError': '無法套用匯率',
};
