...
const system_notice: TranslationStrings = {
  ...
  'system_notice.dev_test_modal.title': '[開發] 測試通知',
  'system_notice.dev_test_modal.body': '這是僅供開發環境使用的測試通知。',
  ...
  'system_notice.thank_you_support.cta_bmc': '請我喝杯咖啡',
  ...
  'system_notice.v3_photos.body':
    '行程規劃器中的​**相片**標籤已被移除。您的相片安全— TREK 從未修改您的 Immich 或 Synology 相簿。\n\n相片現在位於 **旅程** 附加元件中。旅程為選用 — 若尚未啟用，請聯絡管理員於管理後台 → 附加元件中開啟。',
  'system_notice.v3_journey.title': '認識旅程 — 旅行日記',
  'system_notice.v3_journey.body': '將您的旅程記錄為具有時間軸、相片畫庫與互動地圖的豐富旅行故事。',
  'system_notice.v3_journey.cta_label': '開啟旅程',
