...
const settings: TranslationStrings = {
  ...
  'settings.notificationPreferences.push': '推播',
  'settings.webPush.title': '此裝置上的推播通知',
  'settings.webPush.hint': '即使 TREK 已關閉，也會在此裝置上顯示 TREK 通知。收到哪些事件取決於「推播」欄。',
  'settings.webPush.enable': '為此裝置開啟',
  'settings.webPush.disable': '為此裝置關閉',
  'settings.webPush.enabled': '已為此裝置開啟',
  'settings.webPush.unsupported': '此瀏覽器無法接收推播通知。',
  'settings.webPush.insecure': '推播需要透過 HTTPS 開啟 TREK。',
  'settings.webPush.iosInstall': '在 iPhone 和 iPad 上，請先將 TREK 加入主畫面，再從主畫面開啟。',
  'settings.webPush.denied': '此瀏覽器已封鎖 TREK 的通知。請在瀏覽器設定中允許通知，然後再試一次。',
  'settings.webPush.failed': '無法為此裝置開啟推播。',
  ...
  'settings.aiParsing.multimodal': '模型可讀取圖片',
  'settings.aiParsing.multimodalHint': '適用於能讀取圖片的模型，開啟後即可匯入或掃描照片。',
