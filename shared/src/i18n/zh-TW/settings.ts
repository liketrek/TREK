...
const settings: TranslationStrings = {
  ...
  'settings.mapProviderHint': '影響行程規劃和旅程地圖。足跡始終使用 Leaflet。',
  ...
  'settings.aiAlwaysRetry': '始終使用 AI 重試預訂匯入',
  'settings.aiAlwaysRetryHint': '當標準解析器無法讀取檔案時，自動改用 AI 重試。',
  ...
  'settings.notifyVacayInvite': '假期融合邀請',
  'settings.notifyPhotosShared': '共享照片 (Immich)',
  'settings.notifyCollabMessage': '聊天訊息（協作）',
  ...
  'settings.about.supporter.tier.noReturnTicket': '單程票',
  'settings.about.supporter.tier.lostLuggageVip': '行李遺失 VIP',
  'settings.about.supporter.tier.businessClassDreamer': '商務艙夢想家',
  'settings.about.supporter.tier.budgetTraveller': '精打細算旅行者',
  'settings.about.supporter.tier.hostelBunkmate': '青年旅舍室友',
  ...
  'settings.currencyHint': '「費用」中的所有金額都會換算並以此貨幣顯示。',
  'settings.currencyTrip': '行程貨幣',
  'settings.passkey.title': '通行密鑰',
  'settings.passkey.description':
    '使用 通行密鑰 更快登入，並可抵禦網路釣魚——透過你的指紋、臉部、PIN 碼或硬體金鑰。你的密碼仍會保留作為備援。',
  'settings.passkey.notConfigured': '通行密鑰 已啟用，但此伺服器尚未完成設定。請聯絡管理員設定 WebAuthn 網域。',
  'settings.passkey.add': '新增 通行密鑰',
  'settings.passkey.addTitle': '新增 通行密鑰',
  ...
  'settings.passkey.addedToast': '通行密鑰 已新增',
  'settings.passkey.added': '已新增',
  'settings.passkey.addError': '無法新增 通行密鑰',
  'settings.passkey.cancelled': '通行密鑰 設定已取消',
  'settings.passkey.deleted': '通行密鑰 已移除',
  'settings.passkey.deleteConfirm': '要移除此 通行密鑰 嗎？請以密碼確認。',
  'settings.passkey.rename': '重新命名',
  'settings.passkey.defaultName': '通行密鑰',
  ...
  'settings.appearance.scheme.default': '預設',
  'settings.appearance.scheme.highContrast': '高對比度',
  'settings.appearance.scheme.indigo': '靛藍',
  'settings.appearance.scheme.teal': '藍綠',
  'settings.appearance.scheme.rose': '玫瑰',
  'settings.appearance.scheme.amber': '琥珀',
  'settings.appearance.scheme.violet': '紫羅蘭',
  'settings.appearance.scheme.custom': '自訂',
  'settings.appearance.customAccent': '自訂強調色',
  'settings.appearance.contrastOk': '對比度良好',
  'settings.appearance.contrastLow': '對比度偏低',
  'settings.appearance.readability': '可讀性',
  'settings.appearance.transparency': '透明效果',
  'settings.appearance.transparencyHint': '使用玻璃質感的半透明介面；關閉後會改用純色、高對比度背景。',
  'settings.appearance.reduceMotion': '減少動態效果',
  'settings.appearance.reduceMotionHint': '盡量減少動畫和轉場效果。',
  'settings.appearance.density': '版面密度',
  'settings.appearance.comfortable': '舒適',
  'settings.appearance.compact': '精簡',
  'settings.appearance.textSize': '文字大小',
  'settings.appearance.advancedTextSizes': '進階文字大小',
  'settings.appearance.hideAdvanced': '隱藏進階設定',
  'settings.appearance.tier.title': '標題',
  'settings.appearance.tier.subtitle': '副標題',
  'settings.appearance.tier.body': '內文',
  'settings.appearance.tier.caption': '說明文字',
  'settings.appearance.dashboardWidgets': '儀表板小工具',
  'settings.appearance.dashboardWidgetsHint': '可分別控制桌面版和行動版儀表板小工具的顯示。',
  'settings.appearance.desktop': '桌面版',
  'settings.appearance.mobile': '行動版',
  'settings.appearance.widget.sidebar': '右側欄',
  'settings.appearance.widget.currency': '貨幣',
  'settings.appearance.widget.collections': '收藏',
  'settings.appearance.widget.timezones': '時區',
  'settings.appearance.widget.upcomingReservations': '即將到來的預訂',
  'settings.appearance.widget.atlas': '足跡／國家',
  'settings.appearance.widget.tripsTotal': '行程總數',
  'settings.appearance.widget.daysTraveled': '旅行天數',
  'settings.appearance.widget.distanceFlown': '飛行距離',
  'settings.appearance.reset': '重設為預設值',
  'settings.appearance.group.belowHero': '頂部摘要下方',
  'settings.appearance.group.bottomOfPage': '頁面底部',
  'settings.appearance.sidebarHint': '控制整個右側欄；關閉後儀表板會置中顯示。',
  'settings.appearance.densityHint': '精簡模式會縮小間距和內距，讓畫面顯示更多內容。',
  'settings.appearance.textSizeAll': '全部',
  'settings.appearance.perSize': '分別調整每種文字大小',
  'settings.appearance.size.large': '大',
  'settings.appearance.size.medium': '中',
  'settings.appearance.size.normal': '一般',
  'settings.appearance.size.small': '小',
  'settings.appearance.preview.large': '大型標題',
  'settings.appearance.preview.medium': '中型副標題',
  'settings.appearance.preview.normal': '一般內文',
  'settings.appearance.preview.small': '小型說明／地址',
  'settings.appearance.example.large': '標題、大型數字',
  'settings.appearance.example.medium': '次標題',
  'settings.appearance.example.normal': '地點名稱、描述',
  'settings.appearance.example.small': '地址、標籤',
  'settings.appearance.experimental': '實驗性功能',
  'settings.general.languageRegion': '語言與地區',
  'settings.general.travelMap': '旅行與地圖',
  // ── Offline (#1135)
