...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Markdown-formatering',
  'dayplan.markdown.bold': 'Fetstil',
  'dayplan.markdown.italic': 'Kursiv',
  'dayplan.markdown.strikethrough': 'Genomstruken',
  'dayplan.markdown.bulletList': 'Punktlista',
  'dayplan.markdown.numberedList': 'Numrerad lista',
  'dayplan.markdown.inlineCode': 'Infogad kod',
  'dayplan.markdown.link': 'Länk',
