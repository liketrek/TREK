...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.departureIn': 'Salida en',
  'dashboard.hero.hourUnit': 'horas',
  'dashboard.hero.minuteUnit': 'minutos',
  'dashboard.hero.secondUnit': 'segundos',
  ...
  'dashboard.fx.staleSnapshot': 'Instantánea desactualizada',
};
