...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Formato Markdown',
  'dayplan.markdown.bold': 'Negrita',
  'dayplan.markdown.italic': 'Cursiva',
  'dayplan.markdown.strikethrough': 'Tachado',
  'dayplan.markdown.bulletList': 'Lista con viñetas',
  'dayplan.markdown.numberedList': 'Lista numerada',
  'dayplan.markdown.inlineCode': 'Código en línea',
  'dayplan.markdown.link': 'Enlace',
