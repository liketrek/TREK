...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.ride.departureFlight': 'Salida {time}',
  'roadtrip.ride.duration': 'Duración según la reserva',
  'roadtrip.ride.checkIn': 'Check-in',
  'roadtrip.ride.boarding': 'Embarque',
  'roadtrip.ride.missed': 'Perdido',
  'roadtrip.ride.lateBy': '{time} de retraso',
  'roadtrip.ride.reachedAt': 'llega a las {time}',
  'roadtrip.ride.hintFlight': '{title} despega a las {departs}, check-in hasta las {pin}.',
  'roadtrip.ride.hintShip': '{title} zarpa a las {departs}, check-in hasta las {pin}.',
  'roadtrip.ride.hintBoarding': '{title} sale a las {departs}, embarque hasta las {pin}.',
  'roadtrip.ride.lateHintFlight':
    'El trayecto no llega a {place} hasta las {time}. {title} despega a las {departs}, check-in hasta las {pin}.',
  'roadtrip.ride.lateHintShip':
    'El trayecto no llega a {place} hasta las {time}. {title} zarpa a las {departs}, check-in hasta las {pin}.',
  'roadtrip.ride.lateHintBoarding':
    'El trayecto no llega a {place} hasta las {time}. {title} sale a las {departs}, embarque hasta las {pin}.',
  'roadtrip.day.rideMissed.flight': 'Vuelo perdido',
  'roadtrip.day.rideMissed.train': 'Tren perdido',
  'roadtrip.day.rideMissed.ferry': 'Ferry perdido',
  'roadtrip.day.rideMissed.cruise': 'Crucero perdido',
  'roadtrip.day.rideMissed.bus': 'Autobús perdido',
  'roadtrip.bookend.checkOut': 'Salida',
  'roadtrip.bookend.from': 'Inicio del día',
  'roadtrip.bookend.back': 'Pernoctación',
