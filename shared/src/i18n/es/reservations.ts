...
const reservations: TranslationStrings = {
  ...
  'reservations.import.acceptedPhotos': 'El modelo de IA lee las fotos (JPG, PNG, WEBP).',
  ...
  'reservations.createExpenseHint': 'Guarda la reserva y luego abre el editor de gastos.',
  'reservations.linkedExpense': 'Gasto vinculado',
  'reservations.removeExpense': 'Quitar gasto',
  'reservations.linkedExpenses': 'Gastos vinculados',
  'reservations.linkExpense': 'Vincular gasto existente',
  'reservations.unlinkExpense': 'Desvincular, conservar el gasto',
  'reservations.noUnlinkedExpenses': 'No hay gastos sin vincular',
