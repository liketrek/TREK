...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Escanear recibo',
  'costs.scan.reading': 'Leyendo el recibo…',
  'costs.scan.review': 'Revisar el gasto',
  'costs.scan.nothingRead': 'No se pudo leer ningún recibo en esta foto.',
  'costs.scan.failed': 'No se pudo iniciar la lectura del recibo.',
  'costs.scan.title': 'Escanear recibo',
  'costs.scan.accepted': 'Una foto de un solo recibo (JPG, PNG o WEBP, hasta 10 MB). El modelo de IA la lee en segundo plano y luego revisas el gasto antes de guardarlo.',
  'costs.scan.dropHere': 'Suelta aquí la foto del recibo, o haz clic para elegir o hacer una',
  'costs.scan.dropActive': 'Suelta la foto para escanearla',
  'costs.scan.start': 'Escanear',
  'costs.scan.unsupported': 'Solo se puede escanear una foto: JPG, PNG o WEBP.',
