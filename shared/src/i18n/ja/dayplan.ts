...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Markdown 書式',
  'dayplan.markdown.bold': '太字',
  'dayplan.markdown.italic': '斜体',
  'dayplan.markdown.strikethrough': '取り消し線',
  'dayplan.markdown.bulletList': '箇条書き',
  'dayplan.markdown.numberedList': '番号付きリスト',
  'dayplan.markdown.inlineCode': 'インラインコード',
  'dayplan.markdown.link': 'リンク',
