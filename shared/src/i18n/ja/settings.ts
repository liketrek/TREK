...
const settings: TranslationStrings = {
  ...
  'settings.notificationPreferences.push': 'プッシュ',
  'settings.webPush.title': 'このデバイスのプッシュ通知',
  'settings.webPush.hint':
    'TREKを閉じている間も、このデバイスにTREKの通知を表示します。届くイベントは「プッシュ」列の設定に従います。',
  'settings.webPush.enable': 'このデバイスでオンにする',
  'settings.webPush.disable': 'このデバイスでオフにする',
  'settings.webPush.enabled': 'このデバイスでオン',
  'settings.webPush.unsupported': 'このブラウザはプッシュ通知を受信できません。',
  'settings.webPush.insecure': 'プッシュ通知を使うには、TREKをHTTPSで開く必要があります。',
  'settings.webPush.iosInstall': 'iPhoneとiPadでは、まずTREKをホーム画面に追加し、そこから開いてください。',
  'settings.webPush.denied':
    'このブラウザでTREKの通知がブロックされています。ブラウザの設定で許可してから、もう一度お試しください。',
  'settings.webPush.failed': 'このデバイスでプッシュ通知をオンにできませんでした。',
  ...
  'settings.aiParsing.multimodal': 'モデルが画像を読める',
  'settings.aiParsing.multimodalHint': '画像を読めるモデルでオンにすると、写真をインポートやスキャンできます。',
