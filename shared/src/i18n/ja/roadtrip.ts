...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.ride.departureFlight': '出発 {time}',
  'roadtrip.ride.duration': '予約上の所要時間',
  'roadtrip.ride.checkIn': 'チェックイン',
  'roadtrip.ride.boarding': '乗車',
  'roadtrip.ride.missed': '乗り遅れ',
  'roadtrip.ride.lateBy': '{time}遅れ',
  'roadtrip.ride.reachedAt': '{time}着',
  'roadtrip.ride.hintFlight': '{title} は {departs} 発、チェックインは {pin} まで。',
  'roadtrip.ride.hintShip': '{title} は {departs} 出港、チェックインは {pin} まで。',
  'roadtrip.ride.hintBoarding': '{title} は {departs} 発、乗車は {pin} まで。',
  'roadtrip.ride.lateHintFlight':
    '{place} に着くのは {time} です。{title} は {departs} 発、チェックインは {pin} まで。',
  'roadtrip.ride.lateHintShip':
    '{place} に着くのは {time} です。{title} は {departs} 出港、チェックインは {pin} まで。',
  'roadtrip.ride.lateHintBoarding': '{place} に着くのは {time} です。{title} は {departs} 発、乗車は {pin} まで。',
  'roadtrip.day.rideMissed.flight': '飛行機に乗り遅れ',
  'roadtrip.day.rideMissed.train': '列車に乗り遅れ',
  'roadtrip.day.rideMissed.ferry': 'フェリーに乗り遅れ',
  'roadtrip.day.rideMissed.cruise': 'クルーズに乗り遅れ',
  'roadtrip.day.rideMissed.bus': 'バスに乗り遅れ',
  'roadtrip.bookend.checkOut': 'チェックアウト',
  'roadtrip.bookend.from': '出発',
  'roadtrip.bookend.back': '宿泊',
  'roadtrip.bookend.checkIn': 'チェックイン',
