...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'レシートをスキャン',
  'costs.scan.reading': 'レシートを読み取り中…',
  'costs.scan.review': '支出を確認',
  'costs.scan.nothingRead': 'この写真からレシートを読み取れませんでした。',
  'costs.scan.failed': 'レシートの読み取りを開始できませんでした。',
  'costs.scan.title': 'レシートをスキャン',
  'costs.scan.accepted': 'レシート1枚の写真（JPG、PNG、WEBP、10 MB まで）。AI モデルがバックグラウンドで読み取り、保存前に支出を確認します。',
  'costs.scan.dropHere': 'ここにレシートの写真をドロップするか、クリックして選択または撮影',
  'costs.scan.dropActive': 'ドロップしてスキャン',
  'costs.scan.start': 'スキャン',
  'costs.scan.unsupported': 'スキャンできるのは写真（JPG、PNG、WEBP）だけです。',
