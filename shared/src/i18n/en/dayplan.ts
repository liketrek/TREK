...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Markdown formatting',
  'dayplan.markdown.bold': 'Bold',
  'dayplan.markdown.italic': 'Italic',
  'dayplan.markdown.strikethrough': 'Strikethrough',
  'dayplan.markdown.bulletList': 'Bulleted list',
  'dayplan.markdown.numberedList': 'Numbered list',
