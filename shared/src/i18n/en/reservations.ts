...
const reservations: TranslationStrings = {
  ...
  'reservations.linkedExpenses': 'Linked expenses',
  'reservations.linkExpense': 'Link existing expense',
  'reservations.unlinkExpense': 'Unlink, keep the expense',
  'reservations.noUnlinkedExpenses': 'No unlinked expenses',
