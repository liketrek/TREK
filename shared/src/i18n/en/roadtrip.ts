...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.ride.departureFlight': 'Departure {time}',
  'roadtrip.ride.duration': 'Duration per the booking',
  'roadtrip.ride.checkIn': 'Check-in',
  'roadtrip.ride.boarding': 'Boarding',
  'roadtrip.ride.missed': 'Missed',
  'roadtrip.ride.lateBy': '{time} late',
  'roadtrip.ride.reachedAt': 'there at {time}',
  'roadtrip.ride.hintFlight': '{title} departs at {departs}, check-in closes at {pin}.',
  'roadtrip.ride.hintShip': '{title} sails at {departs}, check-in closes at {pin}.',
  'roadtrip.ride.hintBoarding': '{title} departs at {departs}, boarding by {pin}.',
  'roadtrip.ride.lateHintFlight':
    'The drive reaches {place} at {time}. {title} departs at {departs}, check-in closes at {pin}.',
  'roadtrip.ride.lateHintShip':
    'The drive reaches {place} at {time}. {title} sails at {departs}, check-in closes at {pin}.',
  'roadtrip.ride.lateHintBoarding':
    'The drive reaches {place} at {time}. {title} departs at {departs}, boarding by {pin}.',
  'roadtrip.day.rideMissed.flight': 'Flight missed',
  'roadtrip.day.rideMissed.train': 'Train missed',
  'roadtrip.day.rideMissed.ferry': 'Ferry missed',
  'roadtrip.day.rideMissed.cruise': 'Cruise missed',
  'roadtrip.day.rideMissed.bus': 'Bus missed',
  'roadtrip.bookend.checkOut': 'Check-out',
  'roadtrip.bookend.from': 'Day start',
  'roadtrip.bookend.back': 'Overnight',
