...
const settings: TranslationStrings = {
  ...
  'settings.aiParsing.multimodal': 'Model reads images',
  'settings.aiParsing.multimodalHint': 'Turn on for a model that reads images, so a photo can be imported or scanned.',
