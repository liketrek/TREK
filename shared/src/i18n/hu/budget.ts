...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Nyugta beolvasása',
  'costs.scan.reading': 'Nyugta olvasása…',
  'costs.scan.review': 'Kiadás ellenőrzése',
  'costs.scan.nothingRead': 'Erről a fotóról nem sikerült nyugtát olvasni.',
  'costs.scan.failed': 'Nem sikerült elindítani a nyugta olvasását.',
  'costs.scan.title': 'Nyugta beolvasása',
  'costs.scan.accepted': 'Egyetlen nyugta fotója (JPG, PNG vagy WEBP, legfeljebb 10 MB). Az MI-modell a háttérben olvassa be, majd mentés előtt ellenőrzöd a kiadást.',
  'costs.scan.dropHere': 'Húzd ide a nyugta fotóját, vagy kattints egy kiválasztásához vagy elkészítéséhez',
  'costs.scan.dropActive': 'Engedd el a fotót a beolvasáshoz',
  'costs.scan.start': 'Beolvasás',
  'costs.scan.unsupported': 'Csak fotó olvasható be: JPG, PNG vagy WEBP.',
