...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.ride.departureFlight': 'Indulás {time}',
  'roadtrip.ride.duration': 'Időtartam a foglalás szerint',
  'roadtrip.ride.checkIn': 'Utasfelvétel',
  'roadtrip.ride.boarding': 'Beszállás',
  'roadtrip.ride.missed': 'Lekésve',
  'roadtrip.ride.lateBy': '{time} késés',
  'roadtrip.ride.reachedAt': 'érkezés csak {time}',
  'roadtrip.ride.hintFlight': '{title}: indulás {departs}, utasfelvétel {pin}-ig.',
  'roadtrip.ride.hintShip': '{title}: kifutás {departs}, utasfelvétel {pin}-ig.',
  'roadtrip.ride.hintBoarding': '{title}: indulás {departs}, beszállás {pin}-ig.',
  'roadtrip.ride.lateHintFlight': '{place}: érkezés csak {time}. {title}: indulás {departs}, utasfelvétel {pin}-ig.',
  'roadtrip.ride.lateHintShip': '{place}: érkezés csak {time}. {title}: kifutás {departs}, utasfelvétel {pin}-ig.',
  'roadtrip.ride.lateHintBoarding': '{place}: érkezés csak {time}. {title}: indulás {departs}, beszállás {pin}-ig.',
  'roadtrip.day.rideMissed.flight': 'Lekésett járat',
  'roadtrip.day.rideMissed.train': 'Lekésett vonat',
  'roadtrip.day.rideMissed.ferry': 'Lekésett komp',
  'roadtrip.day.rideMissed.cruise': 'Lekésett hajóút',
  'roadtrip.day.rideMissed.bus': 'Lekésett busz',
  'roadtrip.bookend.checkOut': 'Kijelentkezés',
  'roadtrip.bookend.from': 'Napkezdés',
  'roadtrip.bookend.back': 'Éjszakázás',
  'roadtrip.bookend.checkIn': 'Bejelentkezés',
