...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.departureIn': 'Indulásig',
  'dashboard.hero.hourUnit': 'óra',
  'dashboard.hero.minuteUnit': 'perc',
  'dashboard.hero.secondUnit': 'másodperc',
  ...
  'dashboard.fx.staleSnapshot': 'Elavult pillanatkép',
};
