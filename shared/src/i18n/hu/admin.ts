...
const admin: TranslationStrings = {
  ...
  'admin.plugins.devLinkHint': 'Helyi build könyvtárból betöltve és valós adatokkal élőben újratöltve — csak fejlesztéshez',
  ...
  'admin.plugins.perm.db:write:atlas': 'Országok és régiók meglátogatottként jelölése és az aktuális felhasználó bakancslistájának kezelése (az Atlas bővítmény szükséges)',
  'admin.plugins.perm.db:write:vacay': 'Szabadságnapok és céges ünnepek átkapcsolása az aktuális felhasználó aktív tervén (a Vacay bővítmény szükséges)',
  'admin.plugins.perm.db:write:journal': 'Naplóbejegyzések létrehozása, szerkesztése és törlése az aktuális felhasználó által szerkeszthető naplókban (a Journey bővítmény szükséges)',
  'admin.plugins.perm.db:write:collections': 'Gyűjtemények létrehozása és szerkesztése, helyek mentése beléjük, az aktuális felhasználó gyűjteményszerepével (a Collections bővítmény szükséges)',
  'admin.plugins.perm.db:write:files': 'Fájlok csatolása az aktuális felhasználó által szerkeszthető utazásokhoz (10 MB-os korlát, tiltott kiterjesztések elutasítva), és hivatkozásaik kezelése',
  'admin.plugins.perm.db:write:collab': 'Jegyzetek, szavazások és csevegőüzenetek közzététele az aktuális felhasználó által szerkeszthető utazásokon (a Collab bővítmény szükséges)',
  ...
  'admin.plugins.perm.hook:trip-card-provider': 'Kis jelvények (állapot, számlálók) hozzáadása az irányítópult utazáskártyáihoz',
