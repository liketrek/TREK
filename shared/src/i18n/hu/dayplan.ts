...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Markdown formázás',
  'dayplan.markdown.bold': 'Félkövér',
  'dayplan.markdown.italic': 'Dőlt',
  'dayplan.markdown.strikethrough': 'Áthúzott',
  'dayplan.markdown.bulletList': 'Felsorolás',
  'dayplan.markdown.numberedList': 'Számozott lista',
  'dayplan.markdown.inlineCode': 'Soron belüli kód',
  'dayplan.markdown.link': 'Hivatkozás',
