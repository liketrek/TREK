...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Escanear comprovante',
  'costs.scan.reading': 'Lendo o comprovante…',
  'costs.scan.review': 'Revisar a despesa',
  'costs.scan.nothingRead': 'Não foi possível ler um comprovante nesta foto.',
  'costs.scan.failed': 'Não foi possível começar a ler o comprovante.',
  'costs.scan.title': 'Escanear comprovante',
  'costs.scan.accepted': 'A foto de um único comprovante (JPG, PNG ou WEBP, até 10 MB). O modelo de IA lê em segundo plano e depois você confere a despesa antes de salvar.',
  'costs.scan.dropHere': 'Solte aqui a foto do comprovante, ou clique para escolher ou tirar uma',
  'costs.scan.dropActive': 'Solte a foto para escaneá-la',
  'costs.scan.start': 'Escanear',
  'costs.scan.unsupported': 'Só é possível escanear uma foto: JPG, PNG ou WEBP.',
