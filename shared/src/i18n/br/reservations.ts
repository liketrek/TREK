...
const reservations: TranslationStrings = {
  ...
  'reservations.import.acceptedPhotos': 'As fotos (JPG, PNG, WEBP) são lidas pelo modelo de IA.',
  ...
  'reservations.createExpenseHint': 'Salva a reserva e depois abre o editor de despesas.',
  'reservations.linkedExpense': 'Despesa vinculada',
  'reservations.removeExpense': 'Remover despesa',
  'reservations.linkedExpenses': 'Despesas vinculadas',
  'reservations.linkExpense': 'Vincular despesa existente',
  'reservations.unlinkExpense': 'Desvincular, manter a despesa',
  'reservations.noUnlinkedExpenses': 'Nenhuma despesa sem vínculo',
