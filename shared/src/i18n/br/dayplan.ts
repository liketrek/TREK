...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Formatação Markdown',
  'dayplan.markdown.bold': 'Negrito',
  'dayplan.markdown.italic': 'Itálico',
  'dayplan.markdown.strikethrough': 'Tachado',
  'dayplan.markdown.bulletList': 'Lista com marcadores',
  'dayplan.markdown.numberedList': 'Lista numerada',
  'dayplan.markdown.inlineCode': 'Código embutido',
  'dayplan.markdown.link': 'Link',
