...
const admin: TranslationStrings = {
  ...
  'admin.plugins.trustNote': 'Τα plugins εκτελούνται απομονωμένα, μόνο με τα δικαιώματα που εγκρίνετε. Εγκαθιστάτε κώδικα μόνο από δημιουργούς που εμπιστεύεστε.',
