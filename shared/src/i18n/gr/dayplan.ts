...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Μορφοποίηση Markdown',
  'dayplan.markdown.bold': 'Έντονα',
  'dayplan.markdown.italic': 'Πλάγια',
  'dayplan.markdown.strikethrough': 'Διαγράμμιση',
  'dayplan.markdown.bulletList': 'Λίστα με κουκκίδες',
  'dayplan.markdown.numberedList': 'Αριθμημένη λίστα',
  'dayplan.markdown.inlineCode': 'Ενσωματωμένος κώδικας',
  'dayplan.markdown.link': 'Σύνδεσμος',
