...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Σάρωση απόδειξης',
  'costs.scan.reading': 'Ανάγνωση της απόδειξης…',
  'costs.scan.review': 'Έλεγχος εξόδου',
  'costs.scan.nothingRead': 'Δεν ήταν δυνατή η ανάγνωση απόδειξης από αυτή τη φωτογραφία.',
  'costs.scan.failed': 'Δεν ήταν δυνατή η έναρξη ανάγνωσης της απόδειξης.',
  'costs.scan.title': 'Σάρωση απόδειξης',
  'costs.scan.accepted': 'Φωτογραφία μίας απόδειξης (JPG, PNG ή WEBP, έως 10 MB). Το μοντέλο ΤΝ τη διαβάζει στο παρασκήνιο και μετά ελέγχετε το έξοδο πριν αποθηκευτεί.',
  'costs.scan.dropHere': 'Αφήστε εδώ τη φωτογραφία της απόδειξης ή κάντε κλικ για να επιλέξετε ή να τραβήξετε μία',
  'costs.scan.dropActive': 'Αφήστε τη φωτογραφία για σάρωση',
  'costs.scan.start': 'Σάρωση',
  'costs.scan.unsupported': 'Μόνο φωτογραφία μπορεί να σαρωθεί: JPG, PNG ή WEBP.',
