...
const admin: TranslationStrings = {
  ...
  'admin.plugins.devLinkHint': 'Завантажено з локального каталогу збірки та гаряче перезавантажується з реальними даними — лише для розробки',
  ...
  'admin.plugins.perm.db:write:packing': 'Створювати, редагувати та видаляти пункти списку речей у подорожах, які може редагувати поточний користувач',
  ...
  'admin.plugins.perm.db:write:todos': 'Створювати, редагувати та видаляти завдання в подорожах, які може редагувати поточний користувач',
  'admin.plugins.perm.db:write:atlas': 'Позначати країни та регіони як відвідані та керувати списком бажань поточного користувача (потрібен додаток Atlas)',
  'admin.plugins.perm.db:write:vacay': 'Перемикати дні відпустки та корпоративні свята в активному плані поточного користувача (потрібен додаток Vacay)',
  'admin.plugins.perm.db:write:journal': 'Створювати, редагувати та видаляти записи в щоденниках, які може редагувати поточний користувач (потрібен додаток Journey)',
  'admin.plugins.perm.db:write:collections': 'Створювати та редагувати колекції й зберігати в них місця з роллю поточного користувача в колекції (потрібен додаток Collections)',
  'admin.plugins.perm.db:write:files': "Прикріплювати файли до подорожей, які може редагувати поточний користувач (ліміт 10 МБ, заблоковані розширення відхиляються), і керувати їхніми зв'язками",
  'admin.plugins.perm.db:write:collab': 'Публікувати нотатки, опитування та повідомлення чату в подорожах, які може редагувати поточний користувач (потрібен додаток Collab)',
  'admin.plugins.perm.db:write:members': 'Додавати користувачів до подорожей — надає доступ до подорожі; захищено правом керування учасниками поточного користувача',
  'admin.plugins.perm.notify:send': 'Надсилати сповіщення (скринька дзвіночка + email/ntfy) поточному користувачеві або його подорожі — ніколи довільному одержувачу',
  'admin.plugins.perm.ai:invoke': 'Використовувати налаштованого адміністратором ШІ-провайдера (доповнення тексту + видобування з документів) від імені поточного користувача — плагін ніколи не зберігає ключ',
  'admin.plugins.perm.oauth:client': 'Підключення до сторонньої служби від вашого імені через OAuth за посередництва хоста (хост зберігає токени, плагін їх не бачить)',
  ...
  'admin.plugins.perm.db:write:accommodations': 'Створювати, редагувати та видаляти проживання в подорожах, які може редагувати поточний користувач',
