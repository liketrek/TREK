...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.departureIn': 'До відправлення',
  'dashboard.hero.hourUnit': 'годин',
  'dashboard.hero.minuteUnit': 'хвилин',
  'dashboard.hero.secondUnit': 'секунд',
  ...
  'dashboard.fx.staleSnapshot': 'Застарілий знімок',
};
