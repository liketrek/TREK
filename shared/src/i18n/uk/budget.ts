...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Сканувати чек',
  'costs.scan.reading': 'Читання чека…',
  'costs.scan.review': 'Перевірити витрату',
  'costs.scan.nothingRead': 'Не вдалося прочитати чек із цієї фотографії.',
  'costs.scan.failed': 'Не вдалося почати читання чека.',
  'costs.scan.title': 'Сканувати чек',
  'costs.scan.accepted': 'Фото одного чека (JPG, PNG або WEBP, до 10 МБ). Модель ШІ прочитає його у фоні, а потім ви перевірите витрату перед збереженням.',
  'costs.scan.dropHere': 'Перетягніть сюди фото чека або натисніть, щоб вибрати чи зробити знімок',
  'costs.scan.dropActive': 'Відпустіть фото, щоб відсканувати його',
  'costs.scan.start': 'Сканувати',
  'costs.scan.unsupported': 'Сканувати можна лише фото: JPG, PNG або WEBP.',
