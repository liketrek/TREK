...
const admin: TranslationStrings = {
  ...
  'admin.plugins.perm.mcp:tools': 'Offrire i propri strumenti agli assistenti IA collegati a TREK tramite MCP',
  ...
  'admin.plugins.cap.mcpTools': 'Aggiunge strumenti IA',
