...
const admin: TranslationStrings = {
  ...
  'admin.plugins.devLinkHint': 'Caricato da una cartella di build locale e ricaricato a caldo con dati reali — solo per lo sviluppo',
  ...
  'admin.plugins.perm.db:write:todos': "Creare, modificare ed eliminare attività sui viaggi che l'utente attivo può modificare",
  'admin.plugins.perm.db:write:atlas': "Contrassegnare paesi e regioni come visitati e gestire la bucket list dell'utente attivo (richiede il componente aggiuntivo Atlas)",
  'admin.plugins.perm.db:write:vacay': "Attivare/disattivare giorni di ferie e chiusure aziendali sul piano attivo dell'utente attivo (richiede il componente aggiuntivo Vacay)",
  'admin.plugins.perm.db:write:journal': "Creare, modificare ed eliminare voci di diario nei diari che l'utente attivo può modificare (richiede il componente aggiuntivo Journey)",
  'admin.plugins.perm.db:write:collections': "Creare e modificare raccolte e salvarvi luoghi, con il ruolo di raccolta dell'utente attivo (richiede il componente aggiuntivo Collections)",
  ...
  'admin.plugins.perm.db:read:collections': "Leggere le raccolte di luoghi salvati dell'utente attivo (richiede il componente aggiuntivo Collections)",
  'admin.plugins.perm.db:write:daynotes': "Creare, modificare ed eliminare note del giorno sui viaggi che l'utente attivo può modificare",
  'admin.plugins.perm.jobs:run': 'Eseguire i job in background dichiarati secondo una pianificazione (senza contesto utente — non può leggere i dati utente)',
  ...
  'admin.plugins.perm.hook:trip-card-provider': 'Aggiungere piccoli badge (stato, conteggi) alle schede viaggio della dashboard',
