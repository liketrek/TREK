...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Scansiona ricevuta',
  'costs.scan.reading': 'Lettura della ricevuta…',
  'costs.scan.review': 'Controlla la spesa',
  'costs.scan.nothingRead': 'Non è stato possibile leggere una ricevuta da questa foto.',
  'costs.scan.failed': 'Impossibile avviare la lettura della ricevuta.',
  'costs.scan.title': 'Scansiona ricevuta',
  'costs.scan.accepted': 'La foto di una sola ricevuta (JPG, PNG o WEBP, fino a 10 MB). Il modello di IA la legge in background, poi controlli la spesa prima di salvarla.',
  'costs.scan.dropHere': 'Trascina qui la foto della ricevuta, oppure fai clic per sceglierla o scattarla',
  'costs.scan.dropActive': 'Rilascia la foto per scansionarla',
  'costs.scan.start': 'Scansiona',
  'costs.scan.unsupported': 'Si può scansionare solo una foto: JPG, PNG o WEBP.',
