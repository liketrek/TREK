...
const reservations: TranslationStrings = {
  ...
  'reservations.import.acceptedPhotos': 'Le foto (JPG, PNG, WEBP) vengono lette dal modello di IA.',
  ...
  'reservations.costsLabel': 'Costi',
  'reservations.createExpense': 'Crea spesa',
  'reservations.createExpenseHint': 'Salva la prenotazione e poi apre l’editor dei costi.',
  'reservations.linkedExpense': 'Spesa collegata',
  'reservations.removeExpense': 'Rimuovi spesa',
  'reservations.linkedExpenses': 'Spese collegate',
  'reservations.linkExpense': 'Collega spesa esistente',
  'reservations.unlinkExpense': 'Scollega, mantieni la spesa',
  'reservations.noUnlinkedExpenses': 'Nessuna spesa non collegata',
