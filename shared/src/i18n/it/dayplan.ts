...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Formattazione Markdown',
  'dayplan.markdown.bold': 'Grassetto',
  'dayplan.markdown.italic': 'Corsivo',
  'dayplan.markdown.strikethrough': 'Barrato',
  'dayplan.markdown.bulletList': 'Elenco puntato',
  'dayplan.markdown.numberedList': 'Elenco numerato',
  'dayplan.markdown.inlineCode': 'Codice in linea',
  'dayplan.markdown.link': 'Collegamento',
