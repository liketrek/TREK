...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.departureIn': 'Wyjazd za',
  'dashboard.hero.hourUnit': 'godziny',
  'dashboard.hero.minuteUnit': 'minuty',
  'dashboard.hero.secondUnit': 'sekundy',
  ...
  'dashboard.fx.staleSnapshot': 'Nieaktualna migawka',
};
