...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Formatowanie Markdown',
  'dayplan.markdown.bold': 'Pogrubienie',
  'dayplan.markdown.italic': 'Kursywa',
  'dayplan.markdown.strikethrough': 'Przekreślenie',
  'dayplan.markdown.bulletList': 'Lista punktowana',
  'dayplan.markdown.numberedList': 'Lista numerowana',
  'dayplan.markdown.inlineCode': 'Kod w tekście',
  'dayplan.markdown.link': 'Łącze',
