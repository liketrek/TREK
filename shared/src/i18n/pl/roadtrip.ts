...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.ride.departureFlight': 'Wylot {time}',
  'roadtrip.ride.duration': 'Czas trwania według rezerwacji',
  'roadtrip.ride.checkIn': 'Odprawa',
  'roadtrip.ride.boarding': 'Wsiadanie',
  'roadtrip.ride.missed': 'Spóźnienie',
  'roadtrip.ride.lateBy': '{time} spóźnienia',
  'roadtrip.ride.reachedAt': 'dopiero o {time}',
  'roadtrip.ride.hintFlight': '{title} odlatuje o {departs}, odprawa do {pin}.',
  'roadtrip.ride.hintShip': '{title} wypływa o {departs}, odprawa do {pin}.',
  'roadtrip.ride.hintBoarding': '{title} odjeżdża o {departs}, wsiadanie do {pin}.',
  'roadtrip.ride.lateHintFlight': '{place}: przyjazd dopiero o {time}. {title} odlatuje o {departs}, odprawa do {pin}.',
  'roadtrip.ride.lateHintShip': '{place}: przyjazd dopiero o {time}. {title} wypływa o {departs}, odprawa do {pin}.',
  'roadtrip.ride.lateHintBoarding':
    '{place}: przyjazd dopiero o {time}. {title} odjeżdża o {departs}, wsiadanie do {pin}.',
  'roadtrip.day.rideMissed.flight': 'Spóźnienie na lot',
  'roadtrip.day.rideMissed.train': 'Spóźnienie na pociąg',
  'roadtrip.day.rideMissed.ferry': 'Spóźnienie na prom',
  'roadtrip.day.rideMissed.cruise': 'Spóźnienie na rejs',
  'roadtrip.day.rideMissed.bus': 'Spóźnienie na autobus',
  'roadtrip.bookend.checkOut': 'Wymeldowanie',
  'roadtrip.bookend.from': 'Początek dnia',
  'roadtrip.bookend.back': 'Nocleg',
  'roadtrip.bookend.checkIn': 'Zameldowanie',
