...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Zeskanuj paragon',
  'costs.scan.reading': 'Odczytywanie paragonu…',
  'costs.scan.review': 'Sprawdź wydatek',
  'costs.scan.nothingRead': 'Z tego zdjęcia nie udało się odczytać paragonu.',
  'costs.scan.failed': 'Nie udało się rozpocząć odczytu paragonu.',
  'costs.scan.title': 'Zeskanuj paragon',
  'costs.scan.accepted': 'Zdjęcie jednego paragonu (JPG, PNG lub WEBP, do 10 MB). Model AI odczyta je w tle, a potem sprawdzisz wydatek przed zapisaniem.',
  'costs.scan.dropHere': 'Upuść tu zdjęcie paragonu albo kliknij, aby je wybrać lub zrobić',
  'costs.scan.dropActive': 'Upuść zdjęcie, aby je zeskanować',
  'costs.scan.start': 'Skanuj',
  'costs.scan.unsupported': 'Skanować można tylko zdjęcie: JPG, PNG lub WEBP.',
