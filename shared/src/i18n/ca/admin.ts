...
const admin: TranslationStrings = {
  ...
  'admin.plugins.perm.mcp:tools': "Oferir les seves pròpies eines als assistents d'IA connectats a TREK per MCP",
  ...
  'admin.plugins.cap.mcpTools': "Afegeix eines d'IA",
