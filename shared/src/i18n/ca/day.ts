...
const day: TranslationStrings = {
  ...
  'day.climateHint':
    'Mitjanes històriques: el pronòstic real està disponible durant els 16 dies previs a la data.',
  'day.noWeather':
    'No hi ha dades meteorològiques disponibles. Afegeix un lloc amb coordenades.',
