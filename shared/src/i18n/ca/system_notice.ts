...
const system_notice: TranslationStrings = {
  ...
  'system_notice.welcome_v1.hero_alt':
    'Destí de viatge pintoresc amb la interfície de TREK',
  'system_notice.welcome_v1.highlight_plan':
    'Itineraris dia a dia per a qualsevol viatge',
  'system_notice.welcome_v1.highlight_share':
    'Col·labora amb els teus companys de viatge',
  'system_notice.welcome_v1.highlight_offline':
    'Funciona sense connexió en mòbil',
  ...
  'system_notice.v3_mcp.highlight_deprecated':
    'Tokens estàtics trek_ obsolets',
  ...
  'system_notice.v3014_whitespace_collision.title':
    'Acció requerida: conflicte de compte d\'usuari',
