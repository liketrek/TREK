...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Форматирование Markdown',
  'dayplan.markdown.bold': 'Полужирный',
  'dayplan.markdown.italic': 'Курсив',
  'dayplan.markdown.strikethrough': 'Зачёркнутый',
  'dayplan.markdown.bulletList': 'Маркированный список',
  'dayplan.markdown.numberedList': 'Нумерованный список',
  'dayplan.markdown.inlineCode': 'Встроенный код',
  'dayplan.markdown.link': 'Ссылка',
