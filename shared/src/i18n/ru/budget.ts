...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Сканировать чек',
  'costs.scan.reading': 'Чтение чека…',
  'costs.scan.review': 'Проверить расход',
  'costs.scan.nothingRead': 'Не удалось прочитать чек с этой фотографии.',
  'costs.scan.failed': 'Не удалось начать чтение чека.',
  'costs.scan.title': 'Сканировать чек',
  'costs.scan.accepted': 'Фото одного чека (JPG, PNG или WEBP, до 10 МБ). Модель ИИ прочитает его в фоне, а затем вы проверите расход перед сохранением.',
  'costs.scan.dropHere': 'Перетащите сюда фото чека или нажмите, чтобы выбрать или сделать снимок',
  'costs.scan.dropActive': 'Отпустите фото, чтобы отсканировать его',
  'costs.scan.start': 'Сканировать',
  'costs.scan.unsupported': 'Сканировать можно только фото: JPG, PNG или WEBP.',
