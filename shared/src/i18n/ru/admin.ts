...
const admin: TranslationStrings = {
  ...
  'admin.plugins.perm.mcp:tools': 'Предоставлять свои инструменты ИИ-ассистентам, подключённым к TREK по MCP',
  ...
  'admin.plugins.cap.mcpTools': 'Добавляет ИИ-инструменты',
