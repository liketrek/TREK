...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.departureIn': 'المغادرة خلال',
  'dashboard.hero.hourUnit': 'ساعات',
  'dashboard.hero.minuteUnit': 'دقائق',
  'dashboard.hero.secondUnit': 'ثوانٍ',
  ...
  'dashboard.fx.staleSnapshot': 'لقطة أسعار قديمة',
};
