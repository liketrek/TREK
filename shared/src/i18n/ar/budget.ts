...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'مسح إيصال',
  'costs.scan.reading': 'جارٍ قراءة الإيصال…',
  'costs.scan.review': 'مراجعة المصروف',
  'costs.scan.nothingRead': 'تعذّرت قراءة أي إيصال من هذه الصورة.',
  'costs.scan.failed': 'تعذّر بدء قراءة الإيصال.',
  'costs.scan.title': 'مسح إيصال',
  'costs.scan.accepted': 'صورة لإيصال واحد (JPG أو PNG أو WEBP، حتى 10 ميغابايت). يقرأها نموذج الذكاء الاصطناعي في الخلفية، ثم تراجع المصروف قبل حفظه.',
  'costs.scan.dropHere': 'أفلت صورة الإيصال هنا، أو انقر لاختيار صورة أو التقاطها',
  'costs.scan.dropActive': 'أفلت الصورة لمسحها',
  'costs.scan.start': 'مسح',
  'costs.scan.unsupported': 'يمكن مسح الصور فقط: JPG أو PNG أو WEBP.',
