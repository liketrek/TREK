...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.ride.departureFlight': 'الإقلاع {time}',
  'roadtrip.ride.duration': 'المدة حسب الحجز',
  'roadtrip.ride.checkIn': 'تسجيل الوصول',
  'roadtrip.ride.boarding': 'الصعود',
  'roadtrip.ride.missed': 'فاتتك',
  'roadtrip.ride.lateBy': 'متأخر {time}',
  'roadtrip.ride.reachedAt': 'الوصول {time}',
  'roadtrip.ride.hintFlight': '{title} تُقلع في {departs}، وتسجيل الوصول حتى {pin}.',
  'roadtrip.ride.hintShip': '{title} تُبحر في {departs}، وتسجيل الوصول حتى {pin}.',
  'roadtrip.ride.hintBoarding': '{title} تغادر في {departs}، والصعود حتى {pin}.',
  'roadtrip.ride.lateHintFlight':
    'لا تصل الرحلة إلى {place} قبل {time}. {title} تُقلع في {departs}، وتسجيل الوصول حتى {pin}.',
  'roadtrip.ride.lateHintShip':
    'لا تصل الرحلة إلى {place} قبل {time}. {title} تُبحر في {departs}، وتسجيل الوصول حتى {pin}.',
  'roadtrip.ride.lateHintBoarding':
    'لا تصل الرحلة إلى {place} قبل {time}. {title} تغادر في {departs}، والصعود حتى {pin}.',
  'roadtrip.day.rideMissed.flight': 'فاتتك الرحلة الجوية',
  'roadtrip.day.rideMissed.train': 'فاتك القطار',
  'roadtrip.day.rideMissed.ferry': 'فاتتك العبّارة',
  'roadtrip.day.rideMissed.cruise': 'فاتتك الرحلة البحرية',
  'roadtrip.day.rideMissed.bus': 'فاتتك الحافلة',
  'roadtrip.bookend.checkOut': 'تسجيل المغادرة',
  'roadtrip.bookend.from': 'بداية اليوم',
  'roadtrip.bookend.back': 'مبيت',
  'roadtrip.bookend.checkIn': 'تسجيل الوصول',
