...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'تنسيق Markdown',
  'dayplan.markdown.bold': 'عريض',
  'dayplan.markdown.italic': 'مائل',
  'dayplan.markdown.strikethrough': 'يتوسطه خط',
  'dayplan.markdown.bulletList': 'قائمة نقطية',
  'dayplan.markdown.numberedList': 'قائمة مرقمة',
  'dayplan.markdown.inlineCode': 'شفرة ضمن السطر',
  'dayplan.markdown.link': 'رابط',
