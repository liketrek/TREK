...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Bon scannen',
  'costs.scan.reading': 'Bon wordt gelezen…',
  'costs.scan.review': 'Uitgave controleren',
  'costs.scan.nothingRead': 'Uit deze foto kon geen bon worden gelezen.',
  'costs.scan.failed': 'Het lezen van de bon kon niet worden gestart.',
  'costs.scan.title': 'Bon scannen',
  'costs.scan.accepted': 'Een foto van één bon (JPG, PNG of WEBP, max. 10 MB). Het AI-model leest hem op de achtergrond; daarna controleer je de uitgave voordat die wordt opgeslagen.',
  'costs.scan.dropHere': 'Zet de foto van de bon hier neer, of klik om er een te kiezen of te maken',
  'costs.scan.dropActive': 'Laat de foto los om te scannen',
  'costs.scan.start': 'Scannen',
  'costs.scan.unsupported': 'Alleen een foto kan worden gescand: JPG, PNG of WEBP.',
