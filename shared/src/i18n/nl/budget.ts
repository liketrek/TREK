...
const budget: TranslationStrings = {
  ...
  'costs.exchangeRates.description':
    'Reiskoersen zijn de standaardwaarden voor nieuwe uitgaven en betalingen. Eerder opgeslagen koersen blijven ongewijzigd, tenzij je ze hieronder selecteert.',
