...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Markdown-opmaak',
  'dayplan.markdown.bold': 'Vet',
  'dayplan.markdown.italic': 'Cursief',
  'dayplan.markdown.strikethrough': 'Doorhalen',
  'dayplan.markdown.bulletList': 'Opsomming',
  'dayplan.markdown.numberedList': 'Genummerde lijst',
  'dayplan.markdown.inlineCode': 'Inlinecode',
