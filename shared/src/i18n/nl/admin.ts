...
const admin: TranslationStrings = {
  ...
  'admin.plugins.perm.mcp:tools': 'Eigen tools aanbieden aan AI-assistenten die via MCP met TREK zijn verbonden',
  ...
  'admin.plugins.cap.mcpTools': 'Voegt AI-tools toe',
