...
const admin: TranslationStrings = {
  ...
  'admin.plugins.devLinkHint': 'Geladen vanuit een lokale build-map en hot-reload met echte data — alleen voor ontwikkeling',
  ...
  'admin.plugins.perm.db:write:todos': 'Taken aanmaken, bewerken en verwijderen op reizen die de actieve gebruiker mag bewerken',
  'admin.plugins.perm.db:write:atlas': "Landen en regio's als bezocht markeren en de bucketlist van de actieve gebruiker beheren (vereist de Atlas-add-on)",
  'admin.plugins.perm.db:write:vacay': 'Vakantiedagen en bedrijfssluitingen op het actieve plan van de actieve gebruiker omschakelen (vereist de Vacay-add-on)',
  'admin.plugins.perm.db:write:journal': 'Dagboekvermeldingen aanmaken, bewerken en verwijderen in dagboeken die de actieve gebruiker mag bewerken (vereist de Journey-add-on)',
  'admin.plugins.perm.db:write:collections': 'Collecties aanmaken en bewerken en er plaatsen in opslaan, met de collectierol van de actieve gebruiker (vereist de Collections-add-on)',
  'admin.plugins.perm.db:write:files': 'Bestanden toevoegen aan reizen die de actieve gebruiker mag bewerken (limiet 10 MB, geblokkeerde extensies geweigerd) en hun koppelingen beheren',
  'admin.plugins.perm.db:write:collab': 'Notities, peilingen en chatberichten plaatsen op reizen die de actieve gebruiker mag bewerken (vereist de Collab-add-on)',
