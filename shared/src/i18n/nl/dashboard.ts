...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.departureIn': 'Vertrek over',
  'dashboard.hero.hourUnit': 'uur',
  'dashboard.hero.minuteUnit': 'minuten',
  'dashboard.hero.secondUnit': 'seconden',
  ...
  'dashboard.fx.staleSnapshot': 'Verouderde momentopname',
};
