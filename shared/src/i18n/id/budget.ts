...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Pindai kuitansi',
  'costs.scan.reading': 'Membaca kuitansi…',
  'costs.scan.review': 'Tinjau pengeluaran',
  'costs.scan.nothingRead': 'Tidak ada kuitansi yang dapat dibaca dari foto ini.',
  'costs.scan.failed': 'Tidak dapat mulai membaca kuitansi.',
  'costs.scan.title': 'Pindai kuitansi',
  'costs.scan.accepted': 'Foto satu kuitansi (JPG, PNG, atau WEBP, maks. 10 MB). Model AI membacanya di latar belakang, lalu kamu memeriksa pengeluaran sebelum disimpan.',
  'costs.scan.dropHere': 'Letakkan foto kuitansi di sini, atau klik untuk memilih atau mengambil foto',
  'costs.scan.dropActive': 'Lepaskan foto untuk memindainya',
  'costs.scan.start': 'Pindai',
  'costs.scan.unsupported': 'Hanya foto yang dapat dipindai: JPG, PNG, atau WEBP.',
