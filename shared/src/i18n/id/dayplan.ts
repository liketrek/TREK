...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Pemformatan Markdown',
  'dayplan.markdown.bold': 'Tebal',
  'dayplan.markdown.italic': 'Miring',
  'dayplan.markdown.strikethrough': 'Coret',
  'dayplan.markdown.bulletList': 'Daftar berpoin',
  'dayplan.markdown.numberedList': 'Daftar bernomor',
  'dayplan.markdown.inlineCode': 'Kode sebaris',
  'dayplan.markdown.link': 'Tautan',
