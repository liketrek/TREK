...
const settings: TranslationStrings = {
  ...
  'settings.notificationPreferences.push': '推送',
  'settings.webPush.title': '此设备上的推送通知',
  'settings.webPush.hint': '即使 TREK 已关闭，也会在此设备上显示 TREK 通知。收到哪些事件取决于“推送”列。',
  'settings.webPush.enable': '为此设备开启',
  'settings.webPush.disable': '为此设备关闭',
  'settings.webPush.enabled': '已为此设备开启',
  'settings.webPush.unsupported': '此浏览器无法接收推送通知。',
  'settings.webPush.insecure': '推送需要通过 HTTPS 打开 TREK。',
  'settings.webPush.iosInstall': '在 iPhone 和 iPad 上，请先将 TREK 添加到主屏幕，然后从主屏幕打开。',
  'settings.webPush.denied': '此浏览器已阻止 TREK 的通知。请在浏览器设置中允许通知，然后重试。',
  'settings.webPush.failed': '无法为此设备开启推送。',
  ...
  'settings.aiParsing.multimodal': '模型可读取图像',
  'settings.aiParsing.multimodalHint': '适用于能读取图像的模型，开启后可导入或扫描照片。',
