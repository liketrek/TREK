...
const budget: TranslationStrings = {
  ...
  'costs.exchangeRates.manage': '汇率',
  'costs.exchangeRates.title': '行程汇率',
  'costs.exchangeRates.description': '行程汇率是新支出和付款的默认值。除非在下方选中，否则已保存的汇率不会改变。',
  'costs.exchangeRates.notePlaceholder': '可选备注',
  'costs.exchangeRates.updateExisting': '更新现有项目（需要预览）',
  'costs.exchangeRates.noMatchingItems': '没有匹配的现有项目。',
  'costs.exchangeRates.savedDefaults': '已保存的默认值',
  'costs.exchangeRates.noTripRates': '没有行程专用汇率。',
  'costs.exchangeRates.applyItems': '应用到 {count} 个项目',
  'costs.exchangeRates.previewChanges': '预览更改',
  'costs.exchangeRates.saveDefault': '保存默认值',
  'costs.exchangeRates.label': '汇率',
  'costs.exchangeRates.required': '必填',
  'costs.exchangeRates.manualRate': '手动汇率',
  'costs.exchangeRates.sourceLabel': '来源：{source}',
  'costs.exchangeRates.suggestedLabel': '建议：{source}',
  'costs.exchangeRates.staleSnapshot': '服务商快照已过期',
  'costs.exchangeRates.manualRequired': '请输入手动汇率后保存',
  'costs.exchangeRates.source.identity': '相同货币',
  'costs.exchangeRates.source.global': '全局汇率',
  'costs.exchangeRates.source.trip': '行程默认值',
  'costs.exchangeRates.source.explicit': '明确提供的汇率',
  'costs.exchangeRates.source.legacy': '旧版汇率',
  'costs.exchangeRates.source.unavailable': '不可用',
  'costs.exchangeRates.item.expense': '支出',
  'costs.exchangeRates.item.settlement': '付款',
  'costs.exchangeRates.toast.saveError': '无法保存汇率',
  'costs.exchangeRates.toast.previewOutdated': '数据已更改；请创建新的预览',
  'costs.exchangeRates.toast.applyError': '无法应用汇率',
};
