...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': '扫描收据',
  'costs.scan.reading': '正在读取收据…',
  'costs.scan.review': '检查支出',
  'costs.scan.nothingRead': '无法从这张照片中读取收据。',
  'costs.scan.failed': '无法开始读取收据。',
  'costs.scan.title': '扫描收据',
  'costs.scan.accepted': '一张收据的照片（JPG、PNG 或 WEBP，最大 10 MB）。AI 模型在后台读取，保存前你可以检查这笔支出。',
  'costs.scan.dropHere': '将收据照片拖到这里，或点击选择或拍摄照片',
  'costs.scan.dropActive': '松开以扫描照片',
  'costs.scan.start': '扫描',
  'costs.scan.unsupported': '只能扫描照片：JPG、PNG 或 WEBP。',
