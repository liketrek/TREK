...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.bold': '粗体',
  'dayplan.markdown.italic': '斜体',
  'dayplan.markdown.strikethrough': '删除线',
  'dayplan.markdown.bulletList': '项目符号列表',
  'dayplan.markdown.numberedList': '编号列表',
  'dayplan.markdown.inlineCode': '行内代码',
  'dayplan.markdown.link': '链接',
