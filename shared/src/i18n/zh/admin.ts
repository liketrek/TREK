...
const admin: TranslationStrings = {
  ...
  'admin.plugins.perm.geolocation:read': '在其某个视图打开时请求你的实时位置（你的浏览器仍会先询问）',
  ...
  'admin.plugins.perm.mcp:tools': '向通过 MCP 连接到 TREK 的 AI 助手提供自己的工具',
  ...
  'admin.plugins.cap.mcpTools': '添加 AI 工具',
