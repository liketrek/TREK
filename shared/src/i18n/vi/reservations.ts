...
const reservations: TranslationStrings = {
  ...
  'reservations.linkedExpenses': 'Các chi phí liên kết',
  'reservations.linkExpense': 'Liên kết chi phí hiện có',
  'reservations.unlinkExpense': 'Hủy liên kết, giữ chi phí',
  'reservations.noUnlinkedExpenses': 'Không có chi phí chưa liên kết',
