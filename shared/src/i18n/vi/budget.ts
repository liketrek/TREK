...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Quét hóa đơn',
  'costs.scan.reading': 'Đang đọc hóa đơn…',
  'costs.scan.review': 'Xem lại khoản chi',
  'costs.scan.nothingRead': 'Không đọc được hóa đơn nào từ ảnh này.',
  'costs.scan.failed': 'Không thể bắt đầu đọc hóa đơn.',
  'costs.scan.title': 'Quét hóa đơn',
  'costs.scan.accepted': 'Ảnh của một hóa đơn (JPG, PNG hoặc WEBP, tối đa 10 MB). Mô hình AI đọc ảnh ở chế độ nền, sau đó bạn kiểm tra khoản chi trước khi lưu.',
  'costs.scan.dropHere': 'Thả ảnh hóa đơn vào đây, hoặc bấm để chọn hay chụp ảnh',
  'costs.scan.dropActive': 'Thả ảnh để quét',
  'costs.scan.start': 'Quét',
  'costs.scan.unsupported': 'Chỉ có thể quét ảnh: JPG, PNG hoặc WEBP.',
