...
const admin: TranslationStrings = {
  ...
  'admin.ntfy.hint':
    'Cho phép người dùng cấu hình chủ đề ntfy của riêng họ cho thông báo đẩy. Đặt máy chủ mặc định bên dưới để điền trước cài đặt người dùng.',
  ...
  'admin.notifications.adminWebhookPanel.alwaysOnHint': 'Webhook quản trị luôn kích hoạt khi URL được cấu hình',
  'admin.notifications.adminNtfyPanel.title': 'Quản trị viên Ntfy',
  'admin.notifications.adminNtfyPanel.hint':
    'Chủ đề ntfy này được sử dụng riêng cho thông báo của quản trị viên (ví dụ: cảnh báo phiên bản). Nó tách biệt với các chủ đề của mỗi người dùng và luôn kích hoạt khi được cấu hình.',
  ...
  'admin.notifications.adminNtfyPanel.alwaysOnHint': 'Quản trị viên ntfy luôn kích hoạt khi chủ đề được cấu hình',
  'admin.notifications.adminNotificationsHint':
    'Cấu hình kênh nào gửi thông báo chỉ dành cho quản trị viên (ví dụ: cảnh báo phiên bản).',
  ...
  'admin.webhook.hint': 'Cho phép người dùng cấu hình URL webhook của riêng họ để nhận thông báo (Discord, Slack, v.v.).',
  ...
  'admin.fileTypesHint': 'Cấu hình loại tệp mà người dùng có thể tải lên.',
  ...
  'admin.passkey.title': 'Passkey',
  'admin.passkey.cardHint': 'Cho phép người dùng đăng nhập bằng Passkey (WebAuthn). Tắt theo mặc định.',
  'admin.passkey.login': 'Kích hoạt đăng nhập bằng Passkey',
  'admin.passkey.loginHint': 'Hiển thị tùy chọn "Đăng nhập bằng Passkey" và cho phép người dùng đăng ký Passkey trong cài đặt của họ.',
  'admin.passkey.notConfigured':
    'Chưa có miền WebAuthn nào giải quyết được việc triển khai này. Đặt APP_URL hoặc Relying Party ID bên dưới — Passkey sẽ được ẩn cho đến lúc đó.',
  'admin.passkey.rpId': 'Relying Party ID (miền)',
  'admin.passkey.rpIdHint':
    'Passkey gắn với tên miền trần, ví dụ: didau.vn. Để trống để lấy từ APP_URL. Thay đổi sau này sẽ làm mất hiệu lực các Passkey hiện có.',
  'admin.passkey.origins': 'Allowed Origins',
  'admin.passkey.originsHint':
    'Origin đầy đủ, phân tách bằng dấu phẩy, ví dụ: https://didau.vn. Để trống để sử dụng APP_URL.',
  'admin.passkey.reset': 'Đặt lại Passkey',
  'admin.passkey.resetHint':
    'Xóa tất cả Passkey của người dùng này (ví dụ: trên thiết bị bị mất). Họ vẫn có thể đăng nhập bằng mật khẩu của mình.',
  'admin.passkey.resetConfirm': 'Xóa tất cả Passkey cho {name}?',
