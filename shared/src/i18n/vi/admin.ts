...
const admin: TranslationStrings = {
  ...
  'admin.plugins.perm.db:write:atlas': 'Đánh dấu quốc gia và khu vực đã đến và quản lý danh sách mơ ước của người dùng hiện tại (cần add-on Atlas)',
  'admin.plugins.perm.db:write:vacay': 'Chuyển đổi ngày nghỉ phép và ngày nghỉ công ty trên kế hoạch hiện hoạt của người dùng hiện tại (cần add-on Vacay)',
  'admin.plugins.perm.db:write:journal': 'Tạo, chỉnh sửa và xóa mục nhật ký trong các nhật ký mà người dùng hiện tại có quyền chỉnh sửa (cần add-on Journey)',
  'admin.plugins.perm.db:write:collections': 'Tạo và chỉnh sửa bộ sưu tập và lưu địa điểm vào đó, với vai trò bộ sưu tập của người dùng hiện tại (cần add-on Collections)',
  'admin.plugins.perm.db:write:files': 'Đính kèm tệp vào các chuyến đi mà người dùng hiện tại có quyền chỉnh sửa (giới hạn 10 MB, phần mở rộng bị chặn sẽ bị từ chối) và quản lý liên kết của chúng',
  'admin.plugins.perm.db:write:collab': 'Đăng ghi chú, bình chọn và tin nhắn trò chuyện trên các chuyến đi mà người dùng hiện tại có quyền chỉnh sửa (cần add-on Collab)',
