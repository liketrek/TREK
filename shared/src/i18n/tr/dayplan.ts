...
const dayplan: TranslationStrings = {
  ...
  'dayplan.markdown.toolbar': 'Markdown biçimlendirme',
  'dayplan.markdown.bold': 'Kalın',
  'dayplan.markdown.italic': 'İtalik',
  'dayplan.markdown.strikethrough': 'Üstü çizili',
  'dayplan.markdown.bulletList': 'Madde işaretli liste',
  'dayplan.markdown.numberedList': 'Numaralı liste',
  'dayplan.markdown.inlineCode': 'Satır içi kod',
  'dayplan.markdown.link': 'Bağlantı',
