...
const roadtrip: TranslationStrings = {
  ...
  'roadtrip.ride.departureFlight': 'Kalkış {time}',
  'roadtrip.ride.duration': 'Rezervasyona göre süre',
  'roadtrip.ride.checkIn': 'Check-in',
  'roadtrip.ride.boarding': 'Biniş',
  'roadtrip.ride.missed': 'Kaçırıldı',
  'roadtrip.ride.lateBy': '{time} geç',
  'roadtrip.ride.reachedAt': 'varış {time}',
  'roadtrip.ride.hintFlight': '{title}: kalkış {departs}, check-in en geç {pin}.',
  'roadtrip.ride.hintShip': '{title}: hareket {departs}, check-in en geç {pin}.',
  'roadtrip.ride.hintBoarding': '{title}: kalkış {departs}, biniş en geç {pin}.',
  'roadtrip.ride.lateHintFlight': '{place}: varış ancak {time}. {title}: kalkış {departs}, check-in en geç {pin}.',
  'roadtrip.ride.lateHintShip': '{place}: varış ancak {time}. {title}: hareket {departs}, check-in en geç {pin}.',
  'roadtrip.ride.lateHintBoarding': '{place}: varış ancak {time}. {title}: kalkış {departs}, biniş en geç {pin}.',
  'roadtrip.day.rideMissed.flight': 'Uçuş kaçırıldı',
  'roadtrip.day.rideMissed.train': 'Tren kaçırıldı',
  'roadtrip.day.rideMissed.ferry': 'Feribot kaçırıldı',
  'roadtrip.day.rideMissed.cruise': 'Gemi turu kaçırıldı',
  'roadtrip.day.rideMissed.bus': 'Otobüs kaçırıldı',
  'roadtrip.bookend.checkOut': 'Çıkış',
  'roadtrip.bookend.from': 'Gün başlangıcı',
  'roadtrip.bookend.back': 'Konaklama',
  'roadtrip.bookend.checkIn': 'Giriş',
