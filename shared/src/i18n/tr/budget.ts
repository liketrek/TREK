...
const budget: TranslationStrings = {
  ...
  'costs.scan.button': 'Fiş tara',
  'costs.scan.reading': 'Fiş okunuyor…',
  'costs.scan.review': 'Harcamayı gözden geçir',
  'costs.scan.nothingRead': 'Bu fotoğraftan fiş okunamadı.',
  'costs.scan.failed': 'Fiş okuma başlatılamadı.',
  'costs.scan.title': 'Fiş tara',
  'costs.scan.accepted': 'Tek bir fişin fotoğrafı (JPG, PNG veya WEBP, en fazla 10 MB). Yapay zekâ modeli onu arka planda okur, sonra harcamayı kaydetmeden önce kontrol edersin.',
  'costs.scan.dropHere': 'Fiş fotoğrafını buraya bırak ya da seçmek veya çekmek için tıkla',
  'costs.scan.dropActive': 'Taramak için fotoğrafı bırak',
  'costs.scan.start': 'Tara',
  'costs.scan.unsupported': 'Yalnızca fotoğraf taranabilir: JPG, PNG veya WEBP.',
