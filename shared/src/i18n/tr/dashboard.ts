...
const dashboard: TranslationStrings = {
  ...
  'dashboard.hero.departureIn': 'Kalkışa',
  'dashboard.hero.hourUnit': 'saat',
  'dashboard.hero.minuteUnit': 'dakika',
  'dashboard.hero.secondUnit': 'saniye',
  ...
  'dashboard.fx.staleSnapshot': 'Güncel olmayan anlık görüntü',
};
