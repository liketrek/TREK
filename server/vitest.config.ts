  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/nest/reservation-import/**/*.ts': { statements: 58, branches: 52, functions: 39, lines: 58 },
        'src/nest/reservations/**/*.ts': { statements: 92, branches: 83, functions: 93, lines: 95 },
