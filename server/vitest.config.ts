  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/nest/journey/**/*.ts': { statements: 90, branches: 84, functions: 84, lines: 91 },
        ...
        'src/nest/memories/**/*.ts': { statements: 88, branches: 81, functions: 96, lines: 90 },
        'src/nest/notifications/**/*.ts': { statements: 83, branches: 72, functions: 84, lines: 86 },
        ...
        'src/nest/reservations/**/*.ts': { statements: 92, branches: 83, functions: 95, lines: 96 },
