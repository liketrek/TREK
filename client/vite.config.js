  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          { src: 'icons/apple-touch-icon-polaroid-v1-180x180.png', sizes: '180x180', type: 'image/png' },
          { src: 'icons/icon-polaroid-v1-192x192.png', sizes: '192x192', type: 'image/png' },
          { src: 'icons/icon-polaroid-v1-512x512.png', sizes: '512x512', type: 'image/png' },
          { src: 'icons/icon-polaroid-v1-maskable-512x512.png', sizes: '512x512', type: 'image/png', purpose: 'maskable' },
        ],
      },
    }),
  ],
