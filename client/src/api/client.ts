...
export const packingApi = {
  ...
  applyTemplate: (tripId: number | string, templateId: number, data?: PackingApplyTemplateRequest) => apiClient.post(`/trips/${tripId}/packing/apply-template/${templateId}`, data ?? {}).then(r => r.data),
