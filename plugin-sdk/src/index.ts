...
export interface ExchangeRateResolution { trip_id: number; trip_currency: string; item_currency: string; exchange_rate: number; source: ExchangeRateSource; source_version: string; effective_date: string | null; fetched_at: string | null; stale: boolean }
...
export interface PluginContext {
  ...
  costs: {
    ...
    resolveRate(tripId: number, currency: string): Promise<ExchangeRateResolution | null>;
